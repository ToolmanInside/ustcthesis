...
CPT1通过简单的方法就实现了限制函数访问的功能。很多开发者在编写函数的功能的时候，会在实际的功能代码前面加入相关的身份检查，检查合约的访问者是否是合约的持有者或者是否合法。实现身份检查有多种形式，我们举例一种形式如图\ref{fig:ss1_example}所示。
\begin{figure}
